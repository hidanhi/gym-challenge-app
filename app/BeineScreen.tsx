...
export default function BeineScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Beine-Tag Vergleich</Text>
      <Text style={styles.desc}>Trage deine Bein-Übungen ein und vergleiche Danny & Nico!</Text>
      {/* Kopfzeile */}
